...
const (
	Backup_Dir_FullMethodName = "/backup.Backup/Dir"
)
...
func (c *backupClient) Dir(ctx context.Context, in *DirectoryRequest, opts ...grpc.CallOption) (*DirectoryResponse, error) {
	out := new(DirectoryResponse)
	err := c.cc.Invoke(ctx, Backup_Dir_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBackupServer) Dir(context.Context, *DirectoryRequest) (*DirectoryResponse, error) {
...
func _Backup_Dir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DirectoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackupServer).Dir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backup_Dir_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackupServer).Dir(ctx, req.(*DirectoryRequest))
	}
...
var Backup_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Dir",
			Handler:    _Backup_Dir_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/backup_service.proto",
}
